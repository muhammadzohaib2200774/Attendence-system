...
// Data insertion
if (isset($_POST['std'])) {
    $query = "INSERT INTO students (st_id, st_name, st_dept, st_batch, st_sem, st_email) 
...
if (isset($_POST['tcr'])) {
    $query = "INSERT INTO teachers (tc_id, tc_name, tc_dept, tc_email, tc_course) 
    ...
    if ($result) {
        ...
        $error_msg = "Failed to add teacher.";
    }
}
?>
